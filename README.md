...
Well, in terms of looks, it's kinda like I started with Mac OS 8, but then removed all the grayscale bits. Bizarrely, I think System 7 'flat' look has aged better than the 'grayscale' look of Mac OS 8, so I went with that. Most of the visible differences are related to the dialog's popup menus, which are a lot more 'Mac OS 8' than 'System 7'. The scrollbar is definitely more GS/OS though, I never understood why it took so long for macOS to adopt that.
